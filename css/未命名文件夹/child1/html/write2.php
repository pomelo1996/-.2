...
<div class="bdy" ng-app="myAdd" ng-controller="myctrl">
    <div class="serch"></div>
    <div class="search">
        <form id="search-form" action="../pinyin/dowrite.php" method="post" onkeypress="key(e)">
		...
		<div class="hanzi">
			<?php
				...
				if(isset($_POST['pinyin'])){
					...
					//echo $rows;
					if($rows == $myrow){
						echo "回答正确，<a href='write2.php'>继续</a>";
					}else{
						echo "回答错误，<a href='write2.php'>再来一次</a>";
					}
    ...
    <div class="inp" >
        <form id="write" action="write2.php" method="post" class="inp" >
